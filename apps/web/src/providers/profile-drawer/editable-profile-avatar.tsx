...
/**
 * TODO: 이미지 업로드만 하고, 크롭은 지원하지 않도록 할 것.
 */
export function EditableProfileAvatar({
  ...
  const { editProfileImage } = useAuth();
      ...
      <div className="tw-relative tw-group">
        ...
        {currentImage && (
          <Button
            size="icon"
            variant="ghost"
            className="tw-absolute tw--top-2 tw--right-2 tw-container tw-w-6 tw-h-6 tw-rounded-full tw-opacity-0 group-hover:tw-opacity-100 tw-transition-opacity"
